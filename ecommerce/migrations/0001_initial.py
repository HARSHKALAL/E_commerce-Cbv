# Generated by Django 4.1.2 on 2022-12-08 07:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('merchant', 'MERCHANT'), ('consumer', 'CONSUMER')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(related_name='products', to='ecommerce.category')),
                ('sold_by', models.ManyToManyField(to='ecommerce.merchantfirm')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
